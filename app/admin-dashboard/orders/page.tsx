...
import type { Order, Table as TableType, MenuItem } from "@/lib/types"
...
export default function OrdersManagement() {
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(order => 
        ...
        getTableNumber(order.tableId).toString().includes(searchTerm)
      )
    }
  ...
  const getStatusBadge = (status: Order['status']) => {
    const statusConfig = {
      ...
      preparing: { label: "Preparing", variant: "default" as const, icon: Coffee },
      ready: { label: "Ready", variant: "outline" as const, icon: Bell },
      served: { label: "Served", variant: "default" as const, icon: CheckCircle },
